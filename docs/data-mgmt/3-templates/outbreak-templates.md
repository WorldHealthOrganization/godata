...
1) [mpox sync package WITH reference data](https://drive.google.com/file/d/1c-rzV5u3hyuce25MZ2A2_0A5YlAzsvzR/view?usp=drive_link): this option contains the outbreak, forms, and mpox-specific reference data.It also contains a language file.
2) [mpox sync package](https://drive.google.com/file/d/1gfZ2qkfx1aBimDViVvF1JlDFicWs_SRF/view?usp=drive_link): this option contains the mpox outbreak and forms. It also contains a language file. Users can create and customize mpox-specific reference data as needed.
