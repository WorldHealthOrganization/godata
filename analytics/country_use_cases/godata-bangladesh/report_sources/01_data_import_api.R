...
url <- "xxxxxxxxxxxxxxxxxxxxxxxxxxx"                   # <--------------------- insert instance url here, don't forget the slash at end !
username <- "xxxxxxxxxxxxxxxxxxxxxx"                           # <--------------------- insert your username for signing into Go.Data webapp here
password <- "xxxxxxxxxxxxxxxxxxxxxx"                           # <--------------------- insert your password for signing into Go.Data webapp here
outbreak_id <- "xxxxxxxxxxxxxxxxxxxxxx"   # <--------------- insert your outbreak ID here! (find it in URL when you have selected outbreak)
